...
public class CertificateInfo {
    ...
    @Getter
    private Map<String, String> subjectFields;

    @Getter
    private Map<String, String> issuerFields;
    ...
    private Map<String, String> nonCriticalExtensions;
    private Map<String, byte[]> rawExtensions;
    ...
    public String toString() {
        ...
        return """
                ...
                """.formatted(
                subjectFields, issuerFields, serialNumber,
