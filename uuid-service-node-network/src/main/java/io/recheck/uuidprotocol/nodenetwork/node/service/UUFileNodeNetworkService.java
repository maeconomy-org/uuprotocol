...
public class UUFileNodeNetworkService extends NodeNetworkService<UUFile, UUFileDTO>{
    ...
    public UUFileNodeNetworkService(@Value("${uufile-node-network-service.storage-dir-property}") String storageDirProperty,
                                    ...
                                    UUIDRegistrarService uuidRegistrarService,
                                    UUStatementsService uuStatementsService) {
        super(uuFileDataSource, aggregateUUFileEventListener, uuidRegistrarService);
    ...
    @SneakyThrows
    public UUFile storeOrReplaceFile(String uuidToAttach, String uuidFile, MultipartFile file, UserDetailsCustom user) {
        ...
        UUFile uuFile = softDeleteAndCreate(uuFileDTO, user);
        ...
        uuStatementsService.findOrCreateWithOpposite(List.of(uuStatementDTO), user);
